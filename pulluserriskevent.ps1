...
$url = "https://graph.microsoft.com/beta/riskyUsers?`$filter=riskLevel eq microsoft.graph.riskLevel'low' AND riskState eq microsoft.graph.riskState'atRisk'" #Collect filtering
...
GetReport $url "identityUserEvents" $tenantdomain
